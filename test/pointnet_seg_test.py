...
"""
"""
segmentation network (v1.4)
NUM_POINTS = 2048
"""

inputs = keras.Input(shape=(NUM_POINTS, 3))

features_t1 = tnet(inputs, 3)
features_32 = conv_bn(features_t1, 32)
features_64_1 = conv_bn(features_32, 64)
features_64_2 = conv_bn(features_64_1, 64)
features_t2 = tnet(features_64_2, 64)

features_64_3 = conv_bn(features_t2, 64) 
features_128 = conv_bn(features_64_3, 128)
features_512 = conv_bn(features_128, 512)
features_1024 = conv_bn(features_512, 1024)
global_features_1 = layers.MaxPooling1D(pool_size = NUM_POINTS)(features_1024)

global_features_2 = tf.reshape(global_features_1, (-1, 2048, 1024))

# print(features_512)
# print(global_features_1)
# print(global_features_2)


seg_input = layers.Concatenate(name="seg_input")([features_64_2, features_t2, features_64_3, features_128, features_512, global_features_2])

seg_features = dense_bn(seg_input, 256)

outputs = layers.Conv1D(NUM_CLASSES, kernel_size=1, activation="softmax")(seg_features)
